...
Datum pg_dms_id_in(PG_FUNCTION_ARGS) {
...
Datum pg_dms_id_out(PG_FUNCTION_ARGS) {
...
Datum pg_dms_uuid2id(PG_FUNCTION_ARGS) {
...
Datum pg_dms_id_cmp(PG_FUNCTION_ARGS) {
    PG_RETURN_INT32(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)));
};
Datum pg_dms_idgt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)) > 0);
};
Datum pg_dms_idge(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)) >= 0);
};
Datum pg_dms_ideq(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)) == 0);
};
Datum pg_dms_idle(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)) <= 0);
};
Datum pg_dms_idlt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(id_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_PGDMSID_P(1)) < 0);
};
//
//
...
Datum pg_dms_iduuid_cmp(PG_FUNCTION_ARGS) {
    PG_RETURN_INT32(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)));
};
Datum pg_dms_iduuidgt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)) > 0);
};
Datum pg_dms_iduuidge(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)) >= 0);
};
Datum pg_dms_iduuideq(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)) == 0);
};
Datum pg_dms_iduuidle(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)) <= 0);
};
Datum pg_dms_iduuidlt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(iduuid_cmp(PG_GETARG_PGDMSID_P(0), PG_GETARG_UUID_P(1)) < 0);
};
//
//
...
Datum pg_dms_uuidid_cmp(PG_FUNCTION_ARGS) {
    elog(NOTICE, "yra1");
    PG_RETURN_INT32(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)));
};
Datum pg_dms_uuididgt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)) > 0);
};
Datum pg_dms_uuididge(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)) >= 0);
};
Datum pg_dms_uuidideq(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)) == 0);
};
Datum pg_dms_uuididle(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)) <= 0);
};
Datum pg_dms_uuididlt(PG_FUNCTION_ARGS) {
    PG_RETURN_BOOL(uuidid_cmp(PG_GETARG_UUID_P(0), PG_GETARG_PGDMSID_P(1)) < 0);
};
